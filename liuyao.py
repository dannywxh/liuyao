...
class liuyao:
    ...
    def date(self):
        url = 'https://www.nongli.com/plus/riliajax.php?Year=2019&Month=10&Day=30'

        resp = requests.get(url).json()
        zu = resp['dizhi']  #己亥年　甲戌月　庚子日　
    ...
    def draw(self):
        ...
        for i in xrange(6):
            if self.gua[i] == '1':
                ...
                self.canvas.create_text(self.guax, 95 + 150 - 30 * i, text='▅▅▅', font=('Fixdsys', 17, tkFont.BOLD),
                                        tag='pic')
            else:
    ...
    bguastr 112212
        ...
        for i in xrange(6):
            if self.bbgua[i] == '1':
                ...
                self.canvas.create_text(self.guax + 130, 95 + 150 - 30 * i, text=u'▅▅▅', font=('Fixdsys', 17, tkFont.BOLD),
                                        tag='pic')
            else:
